...
namespace Tollab.Admin.Web.Utils
{
    public class PushManager
    {
        ...
        public static void PushToStudentToIphoneDevice(String token, string message, long? NotificationToId, long? ReferenceId)
        {
            try
            {
                ...
                + "\"badge\" : 1" + ", \"sound\":\"default\"}," + "\"NotificationToId\" : " + NotificationToId + "" + "," + "\"ReferenceId\" : " + ReferenceId + " }";
        ...
        public static void PushToTeacherToIphoneDevice(String token, string message, long? NotificationToId, long? ReferenceId)
        {
            try
            {
        ...
        public static void pushToAndroidDevice(String token, string message, long? NotificationToId, long? ReferenceId)
        {
            ...
            gcmBroker.QueueNotification(new GcmNotification
            {
                ...
                Data = JObject.Parse("{ \"message\" : \"" + message + "\",\"ReferenceId\" : \"" + ReferenceId + "\",\"NotificationToId\" : \"" + NotificationToId + "\"}")
            });
        ...
        public static void pushBulkToAndroidDevice(List<string> Tokens, string message, long? NotificationToId, long? ReferenceId)
        {
            string AppId = ConfigurationManager.AppSettings["Push.Android.AppId"];
            string ServerToken = ConfigurationManager.AppSettings["Push.Android.ServerToken"];
