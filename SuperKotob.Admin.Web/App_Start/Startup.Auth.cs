    ...
    public partial class Startup
    {
        ...
        public async void createRoles()
        {
            try
            {
                ...
                if (!rolManager.RoleExists("TeacherAssistant"))
                {
                    role.Name = "TeacherAssistant";
                    await rolManager.CreateAsync(role);
                }
                ...
                if (!rolManager.RoleExists("DeliveryManager"))
                {
                    role.Name = "DeliveryManager";
                    await rolManager.CreateAsync(role);
                }
            }
            catch (Exception e)
